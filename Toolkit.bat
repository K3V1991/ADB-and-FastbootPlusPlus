...
echo ║      2   =   Install Kernel (IMG)                                      ║
echo ║      3   =   Install Recovery (IMG)                                    ║
echo ║      4   =   Push a File to Device                                     ║
echo ║————————————————————————————————————————————————————————————————————————║
echo ║      5   =   Back to the Main Selection                                ║
echo ╚════════════════════════════════════════════════════════════════════════╝
SET /P menunr4=Make your Choice:

IF %menunr4%==1 (goto insa)
IF %menunr4%==2 (goto insb)
IF %menunr4%==3 (goto insr)
IF %menunr4%==4 (goto psh)
IF %menunr4%==5 (goto menu)
goto ins:
...
:cawp
powershell -command "&{$H=get-host;$W=$H.ui.rawui;$B=$W.buffersize;$B.width=90;$B.height=400;$W.buffersize=$B;}"
cls
echo ╔════════════════════════════════════════════════════════════════════════╗
...
echo ║      2   =   Record Video (without Device Sound -  30 Seconds)         ║
echo ║      3   =   Record Video (without Device Sound -  60 Seconds)         ║
echo ║      4   =   Record Video (without Device Sound - 120 Seconds)         ║
echo ║      5   =   Record Video (without Device Sound - 180 Seconds)         ║
echo ║————————————————————————————————————————————————————————————————————————║
...
echo ╚════════════════════════════════════════════════════════════════════════╝
adb shell screenrecord --time-limit=30 /sdcard/Screenrecording.mp4
echo.
pause
goto scrr:
...
echo ╚════════════════════════════════════════════════════════════════════════╝
adb shell screenrecord --time-limit=60 /sdcard/Screenrecording.mp4
echo.
pause
goto scrr:
...
echo ╚════════════════════════════════════════════════════════════════════════╝
adb shell screenrecord --time-limit=120 /sdcard/Screenrecording.mp4
echo.
pause
goto scrr:
...
echo ╚════════════════════════════════════════════════════════════════════════╝
adb shell screenrecord --time-limit=180 /sdcard/Screenrecording.mp4
echo.
pause
goto scrr:
...
echo ╔════════════════════════════════════════════════════════════════════════╗
echo ║                                                                        ║
echo ║                     Reboot, Reboot to X and Logcat                     ║
echo ║                                                                        ║
echo ║════════════════════════════════════════════════════════════════════════║
...
IF %menunr7%==5 (goto logc)
IF %menunr7%==6 (goto menu)
goto rbt
